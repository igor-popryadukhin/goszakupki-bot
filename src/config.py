...
def load_config() -> AppConfig:
    ...
    detail_interval = _get_int("DETAIL_INTERVAL_SECONDS", _get_int("DETAIL_CHECK_INTERVAL_SECONDS", 10))
    ...
    provider_config = ProviderConfig(
        ...
        detail_check_interval_seconds=_get_int("DETAIL_CHECK_INTERVAL_SECONDS", 10),
